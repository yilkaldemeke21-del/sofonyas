...
<head>
    ...
    <style>
        ...
        h1{margin-top:0;color:#1d4ed8}label{display:block;margin-top:12px;font-weight:bold}input, textarea{width:100%;padding:10px;border:1px solid #cbd5e1;border-radius:8px;margin-top:6px}textarea{min-height:140px}button{margin-top:16px;background:#1d4ed8;color:#fff;border:0;padding:10px 16px;border-radius:8px;cursor:pointer}a{display:inline-block;margin-top:16px;color:#1d4ed8;text-decoration:none}
...
<div class="wrap">
    ...
    <a href="admin_lang.php?lang=<?php echo ($_SESSION['admin_lang'] ?? 'am') === 'am' ? 'en' : 'am'; ?>&redirect=admin_add_news.php" style="margin-left:12px;"><?php echo admin_text('language_switch'); ?></a>
</div>
</body>
</html>
